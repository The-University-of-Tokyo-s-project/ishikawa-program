...
#前後で別々のPythonスクリプトファイルを作り、そこから送られたトピックを元にセニアカーを動かすPythonスクリプトファイルを作る

pub = rospy.Publisher('is_back', GoBack, queue_size=10)
...
def listener():
  ...
  rospy.Subscriber("scan_back", LaserScan, callback)
