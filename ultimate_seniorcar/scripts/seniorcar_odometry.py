...
IMU_PITCH_DEFFULT_ANGLE = 0.0#-1.0
IMU_ROLL_DEFAULT_ANGLE  = 0.0#5.0
...
class OdometryCalculator:
    ...
    def __init__(self):
        ...
        IMU_PITCH_DEFFULT_ANGLE = 0#rospy.get_param('~imu_pitch_offset',IMU_PITCH_DEFFULT_ANGLE) * math.pi / 180.0
        IMU_ROLL_DEFAULT_ANGLE= 0#rospy.get_param('~imu_roll_offset',IMU_ROLL_DEFAULT_ANGLE) * math.pi / 180.0
    ...
    def update_pitch_roll(self,data):
        ...
        """       
        self.imu_roll = 0#+= math.pi + IMU_ROLL_DEFAULT_ANGLE  # rollの処理謎
        self.imu_pitch = 0 #-= IMU_PITCH_DEFFULT_ANGLE
        #self.imu_pitch *= -1
        #print(self.imu_roll*180/math.pi)
        #print(self.imu_pitch*180/math.pi)
        """
        ...
        # kamimura
        #self.imu_roll -= 178.48 * math.pi / 180 + math.pi
        #self.imu_pitch += 2.77 * math.pi / 180
